...
Deploy prometheus [memcached_exporter](https://github.com/prometheus/memcached_exporter) using ansible.
...
Please refer to the [collection docs](https://prometheus-community.github.io/ansible/branch/main/memcached_exporter_role.html) for description and default values of the variables.
